...
public class SendSms {
    ...
    public static ApiResult sendSms(String tel, String smsTemplateCode, String smsParam) throws ClientException {
        ...
        if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
        	...
        	apiResult = apiResult.fail(sendSmsResponse.getCode(), sendSmsResponse.getMessage());
        }
